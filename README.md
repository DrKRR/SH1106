...
Inspite of the fact that the SCL and SDA pins of NodeMCU are connected to both OLED and BMP280 sensor, the ESP8266 can identify individual device by its address.
